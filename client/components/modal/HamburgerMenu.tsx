...
import { isShowHamburgerMenu } from '@/redux/features/utils'
...
const HamburgerMenu = () => {
  ...
  return (
    <div className={`${currentIsShowHamburgerMenu?'fixed':'hidden'} z-[60] top-[100px] bottom-0 left-0 right-0  px-[50px] pb-[50px]`}>
