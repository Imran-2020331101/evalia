...
const NavBar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 right-0 h-[80px] flex justify-between px-[20px] z-50'>
      <div className="w-[20%] h-full flex justify-start items-end pl-[30px]">
        <p className={` uppercase text-3xl ${majorMono.className} navSplit`}>Evalia</p>
      ...
      <div className="w-[30%] h-full flex justify-center items-end gap-[25px] text-neutral-300 ">
        <Link href={'/'} className="text-xl font-sans tracking-wider font-extralight hover:text-white cursor-pointer navSplit">Home</Link>
        <Link href={'/auth/register'} className="text-xl font-sans tracking-wider font-extralight hover:text-white cursor-pointer navSplit">Courses</Link>
        <p className="text-xl font-sans tracking-wider font-extralight hover:text-white cursor-pointer navSplit">Services</p>
      </div>
      <div className="w-[20%] h-full flex justify-end items-end pr-[30px]">
        <button className="flex w-[80px] h-[15px] flex-col justify-between group cursor-pointer hamburger-line">
