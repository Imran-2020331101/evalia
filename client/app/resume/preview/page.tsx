    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-4">Please upload a resume first.</p>
          <button
      ...
      <div className="max-w-4xl mx-auto mt-20">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex space-x-3">
            <button
              onClick={handleRetry}
              className="flex items-center px-4 py-2 text-gray-400 border border-gray-600 rounded-md hover:bg-gray-800 transition-colors"
              disabled={isSaving}
            >
        ...
        {saveStatus === 'success' && (
          <div className="mb-6 bg-green-900 border border-green-600 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <span className="text-green-200 font-medium">Resume saved successfully! Redirecting...</span>
            </div>
          </div>
        )}
        ...
        {saveStatus === 'error' && (
          <div className="mb-6 bg-red-900 border border-red-600 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <span className="text-red-200 font-medium">Failed to save resume. Please try again.</span>
            </div>
          </div>
        )}
                    ...
                    if (typeof cert === 'object') {
                      return (
                        <div key={index} className="text-gray-300">
                          ...
                          {cert.link && (
                            <p className="text-sm text-gray-400 mt-1">{cert.link}</p>
                          )}
                        </div>
                      )
                    } else {
